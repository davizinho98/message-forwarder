...
class AutoMessageForwarder:
    ...
    async def forward_message(self, client: Client, message: Message):
        ...
        try:
            ...
            # Encaminha para o grupo de destino específico
    ...
    async def start(self):
        ...
        async with self.app:
            ...
            for i, forwarder in enumerate(self.config["forwarders"], 1):
                ...
                try:
                    target_chat = await self.app.get_chat(target_id)
                    ...
                    logger.error(f"💡 Certifique-se de estar no grupo/canal de destino")
                    continue
